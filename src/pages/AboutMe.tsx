  ...
  return (
    <>
      ...
      <main className="container mx-auto mt-8 px-0 md:px-0 py-8">
        <h1 className="text-4xl font-bold text-gray-800 mb-8 text-center mt-4 md:mt-8">About Me</h1>
        ...
        <section className="relative p-12 mb-12 flex items-center justify-center min-h-[250px] w-full" style={{ backgroundImage: 'url(/images/about_me.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
          <div className="absolute inset-0 bg-black opacity-20"></div>
          <p className="relative text-white text-base md:text-lg font-semibold text-center z-10 px-4 md:px-0">"조금 느릴 수 있지만, 꾸준하게 더 많은 시계 정보와 영상을 전달하는 채널이 되고 싶어요."</p>
        </section>
        <section className="p-8 text-center w-full px-6 md:px-12 mt-8">
