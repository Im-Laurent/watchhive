  ...
  return (
    <div className="mt-6 text-left">
      ...
      <a
        ...
        className="group flex items-center gap-3 bg-gray-50 hover:bg-gray-100 rounded-xl p-3 transition"
      >
        <div className="relative w-28 sm:w-36 shrink-0 aspect-video rounded-lg overflow-hidden bg-gray-200">
          <img
